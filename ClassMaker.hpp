...
/*   Updated: 2021/12/16 13:04:46 by csejault         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class	ClassMaker {
	...
	public:
		...
		int						replace_field(std::string &buff, std::string to_find, std::string new_str);
		...
		int						create_file_from_content(std::string & name, std::string & content);
